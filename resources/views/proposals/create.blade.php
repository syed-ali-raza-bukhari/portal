          ...
          <div class="col-sm-8">
            <div class="card mt-3 mb-3 p-3">
              <form action="/proposals/store" method="post">
                ...
                <div class="form-group">
                  <label>Cast</label>
                  <input type="text" value="{{old('cast')}}" name="cast" class="form-control">
                  @if($errors->has('cast'))
                ...
                <div class="form-group">
                  <label>Sect</label>
                  <input type="text" value="{{old('sect')}}" name="sect" class="form-control">
                  @if($errors->has('sect'))
                ...
                <div class="form-group">
                  <label>Height</label>
                  <input type="number" value="{{old('height')}}" name="height" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" value="{{old('marital_status')}}" name="marital_status" id="">
                    <option></option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="skin_tone" id="">
                    <option></option>
                    <option value="Very Fair" {{old('skin_tone') == 'Very Fair' ? 'selected' : ''}}>Very Fair</option>
                    <option value="Fair" {{old('skin_tone') == 'Fair' ? 'selected' : ''}}>Fair</option>
                    <option value="Light Brown" {{old('skin_tone') == 'Light Brown' ? 'selected' : ''}}>Light Brown</option>
                    <option value="Brown" {{old('skin_tone') == 'Brown' ? 'selected' : ''}}>Brown</option>
                    <option value="Dark" {{old('skin_tone') == 'Dark' ? 'selected' : ''}}>Dark</option>
                  </select>
                ...
                <div class="form-group">
                  <label>Others</label>
                  <textarea class="form-control" value="{{old('others')}}" name="others"></textarea>
